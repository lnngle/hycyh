...
public class CachedMetaDataDialect implements RevengDialect {
	...
	public Iterator<Map<String, Object>> getColumns(String catalog, String schema, String table, String column) {
		...
		if (cached == null) {
			...
			return new CachedIterator(this, cachedColumns, sk, cached,
	...
	public Iterator<Map<String, Object>> getExportedKeys(String catalog, String schema, String table) {
		...
		if (cached == null) {
			cached = new ArrayList<Map<String, Object>>();
			return new CachedIterator(this, cachedExportedKeys, sk, cached,
	...
	public Iterator<Map<String, Object>> getPrimaryKeys(String catalog, String schema, String name) {
		...
		if (cached == null) {
			cached = new ArrayList<Map<String, Object>>();
			return new CachedIterator(this, cachedPrimaryKeys, sk, cached,
	...
	public Iterator<Map<String, Object>> getSuggestedPrimaryKeyStrategyName(String catalog, String schema,
		...
		if (cached == null) {
			cached = new ArrayList<Map<String, Object>>();
			return new CachedIterator(this, cachedPrimaryKeyStrategyName, sk, cached,
	...
	private static class CachedIterator implements Iterator<Map<String, Object>> {
		...
		public CachedIterator(CachedMetaDataDialect owner, Map<StringKey, List<Map<String, Object>>> destination,
				StringKey sk, List<Map<String, Object>> cache, Iterator<Map<String, Object>> realIterator) {
			this.owner = owner;
