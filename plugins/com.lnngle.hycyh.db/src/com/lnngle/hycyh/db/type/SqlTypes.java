package com.lnngle.hycyh.db.type;
...
public class SqlTypes {
	 ...
	 * <p>
	 * Interpreted by Hibernate as a {@link #VARCHAR}-like type large enough to hold
	 * a string of maximum length {@link org.hibernate.Length#LONG}.
	 *
	 ...
	 * {@link org.hibernate.dialect.Dialect} to identify a {@link #VARCHAR}-like
	 * type large enough to hold any Java string.
	 *
	 ...
	 * <p>
	 * Interpreted by Hibernate as a {@link #VARBINARY}-like type large enough to
	 * hold a byte array of maximum length {@link org.hibernate.Length#LONG}.
	 *
	 * @see org.hibernate.Length#LONG
	 *
	...
	/**
	 * A type code used internally by the Hibernate
	 * {@link org.hibernate.dialect.Dialect} to identify a {@link #VARBINARY}-like
	 * type large enough to hold any Java byte array.
	 *
	 * @see org.hibernate.Length#LONG32
	 */
	 ...
	 * code, that identifies the generic SQL type {@code DATALINK}.
	 *
	 * @see Types#DATALINK
	 */
	...
	/**
	 * The constant in the Java programming language, somtimes referred to as a type
	 * code, that identifies the generic SQL type {@code BOOLEAN}.
	 *
	 * @see Types#BOOLEAN
	 */
	 ...
	 * <p>
	 * Interpreted by Hibernate as an {@link #NVARCHAR}-like type large enough to
	 * hold a string of maximum length {@link org.hibernate.Length#LONG}.
	 *
	 * @see org.hibernate.Length#LONG
	 *
	...
	/**
	 * A type code used internally by the Hibernate
	 * {@link org.hibernate.dialect.Dialect} to identify an {@link #NVARCHAR}-like
	 * type large enough to hold any Java string.
	 *
	 * @see org.hibernate.Length#LONG32
	 */
	...
	/**
	 * The constant in the Java programming language, sometimes referred to as a
	 * type code, that identifies the generic SQL type {@code UUID}.
	 *
	...
	/**
	 * The constant in the Java programming language, sometimes referred to as a
	 * type code, that identifies the generic SQL type {@code JSON}.
	 */
	public static final int JSON = 3001;

	/**
	 * The constant in the Java programming language, sometimes referred to as a
	 * type code, that identifies the generic SQL type {@code INET} for IPv4 or IPv6
	 * addresses.
	 */
	...
	/**
	 * The constant in the Java programming language, sometimes referred to as a
	 * type code, that identifies the generic SQL type {@code TIMESTAMP_UTC}.
	 */
	...
	/**
	 * The constant in the Java programming language, sometimes referred to as a
	 * type code, that identifies the generic SQL type {@code INTERVAL SECOND} for a
	 * temporal amount in terms of seconds and fractional seconds.
	 */
	...
	/**
	 * The constant in the Java programming language, sometimes referred to as a
	 * type code, that identifies the generic SQL type {@code GEOMETRY}.
	 */
	public static final int GEOMETRY = 3200;

	/**
	 * The constant in the Java programming language, sometimes referred to as a
	 * type code, that identifies the generic SQL type {@code POINT}.
	 */
	public static final int POINT = 3201;

	/**
	 * The constant in the Java programming language, sometimes referred to as a
	 * type code, that identifies the generic SQL type {@code GEOGRAPHY}.
	 *
	 * @since 6.0.1
	 */
	...
	/**
	 * Does the given JDBC type code represent some sort of variable-length
	...
	/**
	 * Does the given JDBC type code represent some sort of variable-length binary
	 * string type?
	 * 
	 * @param sqlType a JDBC type code from {@link Types}
	 */
	...
	public static boolean isNumericOrDecimal(int typeCode) {
		return typeCode == NUMERIC || typeCode == DECIMAL;
	}
	...
	public static boolean isFloatOrRealOrDouble(int typeCode) {
		return typeCode == FLOAT || typeCode == REAL || typeCode == DOUBLE;
	}
	...
	public static boolean isIntegral(int typeCode) {
		return typeCode == INTEGER || typeCode == BIGINT || typeCode == SMALLINT || typeCode == TINYINT;
	}
	...
	public static boolean isTemporalType(int typeCode) {
		return typeCode == DATE || typeCode == TIME || typeCode == TIMESTAMP || typeCode == TIMESTAMP_WITH_TIMEZONE;
	}
	...
	public static boolean hasDatePart(int typeCode) {
		return typeCode == DATE || typeCode == TIMESTAMP || typeCode == TIMESTAMP_WITH_TIMEZONE;
	}
	...
	public static boolean hasTimePart(int typeCode) {
		return typeCode == TIME || typeCode == TIMESTAMP || typeCode == TIMESTAMP_WITH_TIMEZONE;
	}
}